...
PATH_INPUT=./ukrainian_poetry_short.txt
PATH_OUTPUT_DIR=./ukrainian_poetry_short_1024/
PATH_OUTPUT_GENERATED=./ukrainian_poetry_short_1024/generated.txt
PATH_MODEL=./ukrainian_poetry_short_1024/model.json
GEN_SIZE=1000
...
yarn train $PATH_INPUT --lstmLayerSize 1024,1024 --epochs 300 --savePath $PATH_OUTPUT_DIR --gpu
