...
PATH_OUTPUT_GENERATED=./ukrainian_poetry_512/ukrainian_poetry_512_generated.txt
...
yarn train $PATH_INPUT --lstmLayerSize 512,512 --epochs 100 --savePath $PATH_OUTPUT_DIR --gpu
