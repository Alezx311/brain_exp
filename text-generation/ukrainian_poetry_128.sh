...
PATH_OUTPUT_DIR=./ukrainian_poetry_128/
PATH_OUTPUT_GENERATED=./ukrainian_poetry_128/generated.txt
PATH_MODEL=./ukrainian_poetry_128/model.json
GEN_SIZE=1000
...
yarn train $PATH_INPUT --lstmLayerSize 128,128 --epochs 300 --savePath $PATH_OUTPUT_DIR --gpu
