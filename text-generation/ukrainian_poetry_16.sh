...
PATH_OUTPUT_DIR=./ukrainian_poetry_16/
PATH_OUTPUT_GENERATED=./ukrainian_poetry_16/generated.txt
PATH_MODEL=./ukrainian_poetry_16/model.json
GEN_SIZE=1000
...
yarn train $PATH_INPUT --lstmLayerSize 16,16 --epochs 300 --savePath $PATH_OUTPUT_DIR --gpu
